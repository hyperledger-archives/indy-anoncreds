...
\begin{align}
\widehat{T_1} &\leftarrow Z^{\widetilde{u_1}}S^{\widetilde{r_1}}\pmod{n}& 
\widehat{T_2} &\leftarrow Z^{\widetilde{u_2}}S^{\widetilde{r_2}}\pmod{n}\\
\widehat{T_3} &\leftarrow Z^{\widetilde{u_3}}S^{\widetilde{r_3}}\pmod{n} &
 \widehat{T_4} &\leftarrow Z^{\widetilde{u_4}}S^{\widetilde{r_4}}\pmod{n}\\
\widehat{T_{\Delta}} &\leftarrow  Z^{\widetilde{m_j}}S^{\widetilde{r_{\Delta}}} \pmod{n};
\end{align}
...
T_3^{\widetilde{u_3}} T_4^{\widetilde{u_4}}S^{\widetilde{\alpha}}
$$
Add $Q$ to $\mathcal{T}$.
\end{enumerate}  
\item[3] Compute 
